...
namespace NonsensicalKit.Simulation.WarehouseSimulation.Simulation
{
    ...
    public sealed partial class StackerWarehouseSimulator
    {
        ...
        private readonly Queue<int> _inboundWaitingFlowEntryIndices = new();
        private readonly Queue<int> _outboundWaitingFlowEntryIndices = new();
        ...
        private void InitFlowPlan()
        {
            ...
            _outboundWaitingFlowEntryIndices.Clear();
        }
        ...
        private void OnFlowCargoRelease(int entryIndex)
        {
            ...
            if (direction == SimFlowDirection.Outbound)
            {
                ...
                _outboundWaitingFlowEntryIndices.Enqueue(entryIndex);
            ...
            else
            {
                ...
                _inboundWaitingFlowEntryIndices.Enqueue(entryIndex);
                WarehouseSimLog.Info(
