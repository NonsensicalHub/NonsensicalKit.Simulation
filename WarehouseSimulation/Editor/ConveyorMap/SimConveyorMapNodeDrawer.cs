        ...
        private static float KindFieldsHeight(SerializedProperty property, SimConveyorNodeKind kind)
        {
            ...
            switch (kind)
            {
                ...
                case SimConveyorNodeKind.ProcessStation:
                    height += PropertyHeight(property, "ProcessMode");
                    height += PropertyHeight(property, "ProcessTag");
                    height += PropertyHeight(property, "ProcessServiceSeconds");
                    break;
                case SimConveyorNodeKind.VerticalTransfer:
                    height += PropertyHeight(property, "TransferGroupId");
                    height += PropertyHeight(property, "TransferSeconds");
                    height += PropertyHeight(property, "TransferTargetLogicalId");
                    height += PropertyHeight(property, "TransferMotion");
                    break;
            }
            ...
            SerializedProperty property)
        {
            switch (kind)
            {
                ...
                case SimConveyorNodeKind.OutfeedPort:
                    ...
                    break;
                case SimConveyorNodeKind.ProcessStation:
                    y = DrawField(x, y, width, line, property, "ProcessMode");
                    y = DrawField(x, y, width, line, property, "ProcessTag");
                    y = DrawField(x, y, width, line, property, "ProcessServiceSeconds");
                    break;
                case SimConveyorNodeKind.VerticalTransfer:
                    y = DrawField(x, y, width, line, property, "TransferGroupId");
                    y = DrawField(x, y, width, line, property, "TransferSeconds");
                    y = DrawField(x, y, width, line, property, "TransferTargetLogicalId");
                    y = DrawField(x, y, width, line, property, "TransferMotion");
                    break;
            }
