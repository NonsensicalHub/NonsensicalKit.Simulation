...
{
    /// <summary>
    /// 示例场景用：IK 目标在若干路径点间平滑移动，配合 <see cref="RobotArmAnim"/> 运行时跟随。
    /// </summary>
    [AddComponentMenu("")]
    public class RobotArmRigDemoDriver : MonoBehaviour
    {
        [SerializeField] private RobotArmAnim m_arm;
        [SerializeField] private Transform[] m_waypoints;
        [SerializeField] private float m_moveSpeed = 1.4f;
        [SerializeField] private float m_pauseAtWaypoint = 0.35f;
